...
class Navbar extends React.Component {
  ...
  static getDerivedStateFromProps({ ShadowPrefix, expanded }, prevState) {
    return {
      navbarContext: {
  ...
  render() {
    ...
    let expandClass = `${ShadowPrefix}-expand`;
...
const DecoratedNavbar = createShadowComponent(
...
DecoratedNavbar.Text = createWithShadowPrefix('shadow-navbar-text', {
  Component: 'span',
});
