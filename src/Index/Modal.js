...
import ShadowModalManager from './utils/ShadowModalManager';
...
const defaultProps = {
  ...
  manager: new ShadowModalManager(),
};
...
class Modal extends React.Component {
  ...
  renderBackdrop = props => {
    const { ShadowPrefix, backdropClassName } = this.props;

    return (
      <div
        {...props}
        className={classNames(`${ShadowPrefix}-backdrop`, backdropClassName)}
      />
    );
  };
      ...
      <ModalContext.Provider value={this.modalContext}>
        <BaseModal
          {...{
            ...
            containerClassName: `${ShadowPrefix}-open`,
...
const DecoratedModal = createShadowComponent(Modal, 'shadow-modal');
